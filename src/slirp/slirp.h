...
void tcp_dooptions(struct tcpcb *, unsigned char *, int, struct tcpiphdr *);
void tcp_xmit_timer(register struct tcpcb *, int);
unsigned int tcp_mss(register struct tcpcb *, unsigned int);
