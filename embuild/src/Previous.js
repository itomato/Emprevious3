...
var FS = {
    ...
    createDefaultDevices: () => {
        ...
        var randomByte = () => {
            if (randomLeft === 0) {
                randomLeft = randomFill(randomBuffer)
                    .byteLength
            }
            ...
            if (ws) {
                ...
                try {
                    ...
                    if (url === "ws://" || url === "wss://") {
                        ...
                        url = url + parts[0] + ":" + port + "/" + parts.slice(1)
                            .join("/")
                    }
                    ...
                    if (subProtocols !== "null") {
                        subProtocols = subProtocols.replace(/^ +| +$/g, "")
                            .split(/ *, */);
                        opts = subProtocols
                    }
...
var inetNtop6 = ints => {
    ...
    for (word = 0; word < 8; word++) {
        ...
        str += Number(_ntohs(parts[word] & 65535))
            .toString(16);
        str += word < 7 ? ":" : ""
    }
    return str
